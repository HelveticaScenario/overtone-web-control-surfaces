...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_136960 = 0;while(true){
var m_136961 = cljs.core.async.impl.dispatch.tasks.pop();if((m_136961 == null))
{} else
{m_136961.call(null);
if((count_136960 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__136962 = (count_136960 + 1);
count_136960 = G__136962;
continue;
}
} else
{}
