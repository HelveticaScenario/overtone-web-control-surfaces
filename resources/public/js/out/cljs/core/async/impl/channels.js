...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t136966 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t136966 = (function (val,box,meta136967){
this.val = val;
this.box = box;
this.meta136967 = meta136967;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t136966.cljs$lang$type = true;
cljs.core.async.impl.channels.t136966.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t136966";
cljs.core.async.impl.channels.t136966.cljs$lang$ctorPrWriter = (function (this__4048__auto__,writer__4049__auto__,opt__4050__auto__){return cljs.core._write.call(null,writer__4049__auto__,"cljs.core.async.impl.channels/t136966");
});
cljs.core.async.impl.channels.t136966.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t136966.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_136968){var self__ = this;
var _136968__$1 = this;return self__.meta136967;
});
cljs.core.async.impl.channels.t136966.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_136968,meta136967__$1){var self__ = this;
var _136968__$1 = this;return (new cljs.core.async.impl.channels.t136966(self__.val,self__.box,meta136967__$1));
});
cljs.core.async.impl.channels.__GT_t136966 = (function __GT_t136966(val__$1,box__$1,meta136967){return (new cljs.core.async.impl.channels.t136966(val__$1,box__$1,meta136967));
});
}
return (new cljs.core.async.impl.channels.t136966(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_136969 = self__.takes.pop();if((taker_136969 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_136969))
{var take_cb_136970 = cljs.core.async.impl.protocols.commit.call(null,taker_136969);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_136970,taker_136969,this$__$1){
return (function (){return take_cb_136970.call(null,null);
});})(take_cb_136970,taker_136969,this$__$1))
);
} else
{}
{
...
var putter_136971 = self__.puts.pop();if(!((putter_136971 == null)))
{var put_handler_136972 = putter_136971.handler;var val_136973 = putter_136971.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_136972))
{var put_cb_136974 = cljs.core.async.impl.protocols.commit.call(null,put_handler_136972);var __136975__$1 = cljs.core.async.impl.protocols.commit.call(null,handler);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_136974,__136975__$1,put_handler_136972,val_136973,putter_136971,_,retval,this$__$1){
return (function (){return put_cb_136974.call(null,true);
});})(put_cb_136974,__136975__$1,put_handler_136972,val_136973,putter_136971,_,retval,this$__$1))
);
cljs.core.async.impl.protocols.add_BANG_.call(null,self__.buf,val_136973);
} else
{{
continue;
}
