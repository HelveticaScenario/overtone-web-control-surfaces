...
{{
var G__137794 = cljs.core.pop.call(null,v__$1);
v__$1 = G__137794;
continue;
}
} else
...
{var pred__137798 = cljs.core._EQ_;var expr__137799 = limit;if(cljs.core.truth_(pred__137798.call(null,1,expr__137799)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__137798.call(null,2,expr__137799)))
...
var G__137801 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__137802 = (limit__$1 - 1);
var G__137803 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__137801;
limit__$1 = G__137802;
parts = G__137803;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___137805 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___137805))
{var replacement_137806 = temp__4124__auto___137805;buffer.append([cljs.core.str(replacement_137806)].join(''));
} else
{buffer.append(ch);
}
{
var G__137807 = (index + 1);
index = G__137807;
continue;
}
}
